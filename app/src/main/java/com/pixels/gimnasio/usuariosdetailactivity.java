 ...
 */
public class usuariosdetailactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(usuariosdetailfragment.ARG_ITEM_ID,
								getIntent().getStringExtra(usuariosdetailfragment.ARG_ITEM_ID));
