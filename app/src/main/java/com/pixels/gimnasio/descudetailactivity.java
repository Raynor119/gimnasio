 ...
 */
public class descudetailactivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			arguments.putString(descudetailfragment.ARG_ITEM_ID,
								getIntent().getStringExtra(descudetailfragment.ARG_ITEM_ID));
