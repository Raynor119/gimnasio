package com.pixels.gimnasio;
	 ...
	 */
public class preciodetailactivity extends AppCompatActivity {
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			if (savedInstanceState == null) {
				...
				arguments.putString(preciodetailfragment.ARG_ITEM_ID,
									getIntent().getStringExtra(preciodetailfragment.ARG_ITEM_ID));
